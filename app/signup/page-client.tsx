      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              "Extract structured data from free-form text with just a few clicks. Our AI does the heavy lifting for
              you."
            </p>
            <footer className="text-sm">The JSONonify Team</footer>
          </blockquote>
        </div>
      </div>
